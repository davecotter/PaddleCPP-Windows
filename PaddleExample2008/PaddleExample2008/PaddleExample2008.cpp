// PaddleExample2008.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "PaddleExample2008.h"
#include "PaddleCLR.h"
                     ...
                     int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_PADDLEEXAMPLE2008, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_PADDLEEXAMPLE2008));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_PADDLEEXAMPLE2008));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_PADDLEEXAMPLE2008);
